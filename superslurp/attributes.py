"""Vocabulary, regex patterns, and extractor functions used at parse time
to populate item attributes (bio, brand, milk treatment, packaging, origin,
affinage, baby food, etc.) and at compare time to normalize matching strings.

Neutral module — imported by both ``parse`` and ``compare``."""
...
# Whitespace collapse, used by expand_synonyms, strip_quality_label, and
# (by import) normalize.normalize_for_matching.
...
# ---------------------------------------------------------------------------
# Synonyms (shared by parse-time expansion and compare-time normalization)
# ---------------------------------------------------------------------------

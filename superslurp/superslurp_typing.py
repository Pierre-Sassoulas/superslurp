...
class Category(enum.Enum):
    ...
    ECLAIRAGE_ELECTRICITE = "ECLAIRAGE ELECTRICITE"
    SOUS_VETEMENT = "SOUS-VETEMENT"

    # V2 categories
    AIDE_PATISSERIE = "AIDE PATISSERIE"
    AIDES_A_LA_CUISINE = "AIDES A LA CUISINE"
    ...
    POISSON_FRAIS_PREEMBALLE = "POISSON FRAIS PREEMBALLE"
    ...
    SEL = "SEL"
    SOUS_VETEMENT_H = "S.VETEMENT HOMME"
    SIROPS = "SIROPS"
    SUCRES = "SUCRES"
